...
works, you can play a working demo of the game [__here__][galumphing]. Simply
...
## Diving in
The code and tutorial for this lab will be hosted on GitHub. Explanations of
each step are written in the _git commits_, and you can also see the code diffs
for each step to see what changed. For simplicity, each step will be listed
below with a link to the code for that step. Most of the explanations will not
make sense if you do not also take a look at the corresponding code.
